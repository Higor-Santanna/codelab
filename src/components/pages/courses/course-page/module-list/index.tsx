...
export const ModulesList = ({ modules }: ModulesListProps) => {
  ...
  return (
    ...
    >
      <div className={cn("absolute z-10 left-0 top-0 bottom-0 w-4 flex justify-start group cursor-e-resize group", modulesListCollapsed && "cursor-w-resize")} onClick={handleToggleCollapsed}>
      ...
      {modulesListCollapsed ? (
        ...
        <>
          <Button variant="outline" onClick={handleToggleCollapsed} className="w-full flex sm:hidden mb-4">
            Fechar módulos
          </Button>
